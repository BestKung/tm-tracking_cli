...
var CheckListButtonComponent = (function () {
    function CheckListButtonComponent(router, route) {
        this.router = router;
        this.route = route;
    }
    CheckListButtonComponent.prototype.goToChecklistPage = function () {
        ...
        var redirectUrl = ['/verify-documents/checklist', this.reqNo, this.docType];
...
], CheckListButtonComponent.prototype, "docType", void 0);
CheckListButtonComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        selector: "checklist-component",
        templateUrl: 'checklist-btn.html'
    }),
