...
export function httpFactory(backend: XHRBackend, defaultOptions: RequestOptions, pubsub: HttpStatusBus)   {
  return  new InterceptHttp(backend, defaultOptions, pubsub);
